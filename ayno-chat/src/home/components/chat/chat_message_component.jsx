    ...
    return (
        ...
        <div className="w-full h-full  mb-3">
            <div className={`flex ${props.isUser ? "float-right" : "float-left"} items-end`}>
                {/* profile image */}
                <img alt="user profile" src={user.profileImagePath === props.message.sender_image_path ? userProfilePath : contact.profileImagePath} className="h-7 w-7 p-1 rounded-full" />
                {/* text container */}
