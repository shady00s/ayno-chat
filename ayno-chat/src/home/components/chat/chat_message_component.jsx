    ...
    return (
        ...
        <div className="w-full h-full  mb-3">
            <div className={`flex ${props.message.messages.sender_id ===user.id ? "float-right" : "float-left"} items-end`}>
                ...
                <div style={{ maxWidth: "23rem", minWidth: "2rem", overflowWrap: "break-word" }} className={`${props.message.messages.sender_id ===user.id ? guestMainContainerStyle : ownerMainContainerStyle} relative rounded-md p-1  inline-block`}>
