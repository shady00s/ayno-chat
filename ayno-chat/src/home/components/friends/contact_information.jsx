  ...
  return (
    <>
      {width <= 868 ? (
        ...
        <div
          className={`${
            isMobile ? "opacity-1  visible" : "opacity-0  invisible"
          } overflow-x-hidden     transition-opacity absolute flex justify-end  right-0 bg-theme w-full h-full ease-in duration-300`}
        >
          {/* main container */}
          <div
            className={`${
          ...
          >
            <img
              className=" ml-auto mr-auto  rounded-full w-20 mt-10"
