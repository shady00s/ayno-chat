    ...
    return (
        ...
        <div className="w-full h-full  mb-3">
            <div className={`flex ${props.isUser ? "float-right" : "float-left"} items-end`}>
                ...
                <div style={{ maxWidth: "23rem", minWidth: "2rem", overflowWrap: "break-word" }} className={`${props.isUser ? ownerMainContainerStyle : `bg-[${guestColor}] mr-2 `} relative rounded-md p-1  inline-block`}>
