    ...
    <div className="flex items-center bg-subBackGround p-1 m-1 mb-3 rounded-md">
        <div className=" w-full">
            ...
            <div className="pt-2 pb-2 flex justify-center w-full">
              ...
              {!props.data.isFriend? <button className="m-auto p-1 rounded-md text-slate-300 border-2 border-slate-800 flex justify-center items-center text-sm"><UserPlus className="mr-1 stroke-sky-600" size={17}/> Add Friend</button>:null}  
