        ...
        <>
            <div className="absolute  bg-background w-full h-full left-12 z-40">
                ...
                <div className="flex h-full flex-wrap overflow-y-auto">
                     {/* personal info */}
                <div className="  md:w-6/12 w-full flex flex-wrap h-5/6 overflow-y-auto">
                   
                    <div className=" flex flex-wrap w-6/12 ml-8 mb-5">
                        
                        <h2 className=" mb-2 text-2xl text-slate-200 border-">Personal Info</h2>
