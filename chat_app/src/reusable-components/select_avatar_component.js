...
const SelectAvatarComponent = () => {
    ...
    return (
        ...
        <div className="flex justify-between items-center flex-wrap w-2/3">
                        <h2 className="text-slate-200 text-md mb-2 mt-5">Select your avatar</h2>

                           <div className="h-full flex justify-between items-center m-2 mt-4" >
                            <button onClick={()=>{
                                console.log('x')
            ...
            <div style={{width:"16rem",height:"20rem"}} className='flex flex-wrap overflow-y-auto p-1'>
